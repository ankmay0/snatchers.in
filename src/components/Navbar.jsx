...
import { FaSearch, FaShoppingBag, FaTrashAlt, FaUser, FaBars, FaTimes, FaHeart } from 'react-icons/fa';
        ...
        <div className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <a href="/" className="flex items-center">
              <img src="/logo-black.png" alt="Logo" className="h-10 w-auto max-w-full lg:h-[4rem]" />
